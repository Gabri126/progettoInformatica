...
<fieldset class="logpad">
    ...
    $s="SELECT cognome,nome,password FROM admin WHERE username='$username' AND password='$password'";
    ...
    if (mysqli_num_rows($ris) > 0) {
        while($row = mysqli_fetch_assoc($ris)) {
            ...
            header('location:funzioniamm.php');
        ...
        { echo "Credenziali errate! <P>";
            echo "<A HREF='loginamm.html'>Riprova login</A>";}
        else {
